...
llm = ChatOllama(model=llm_model_name, temperature=0, base_url="http://127.0.0.1:11443")
embeddings = OllamaEmbeddings(model=embeddings_model_name, base_url="http://127.0.0.1:11443")
