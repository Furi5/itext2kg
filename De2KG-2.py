...
def process_pmid(pmid, pubtator_path, output_path, llm_model_name, embeddings_model_name):
    ...
    try:
        ...
        # Load context
        llm = ChatOllama(model=llm_model_name, temperature=0, base_url="http://127.0.0.1:11435")
        embeddings = OllamaEmbeddings(model=embeddings_model_name, base_url="http://127.0.0.1:11435")
